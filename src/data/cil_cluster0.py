...
@DATAHANDLER_REGISTRY.register("cil_cluster0")
class CILDataHandler(DataHandler):
    dataset_path = DATA_PATH.joinpath("cil_cluster0")
    ...
    def get_train_val_dataloaders(self) -> Tuple[DataLoader, DataLoader]:
        train_dataset = CIL_Cluster0Dataset(
            self.train_image_paths,
            self.train_mask_paths,
            PATCH_SIZE,
            CUTOFF,
        ...
        val_dataset = CIL_Cluster0Dataset(
            self.val_image_paths,
            self.val_mask_paths,
            PATCH_SIZE,
            CUTOFF,
...
@DATASET_REGISTRY.register("cil_cluster0")
class CIL_Cluster0Dataset(Dataset):
