...
@DATAHANDLER_REGISTRY.register("30k")
class NinetyKDataHandler(DataHandler):
    dataset_path = DATA_PATH.joinpath("30k")
...
@DATASET_REGISTRY.register("30k")
class ThirtyKDataset(Dataset):
