...
@DATAHANDLER_REGISTRY.register("cluster0")
class Cluster0DataHandler(DataHandler):
    dataset_path = DATA_PATH.joinpath("clusters")
    dataset_path = dataset_path.joinpath("cluster0")
...
@DATASET_REGISTRY.register("cluster0")
class Cluster0Dataset(RoadSegDataset):

    def __getitem__(self, item):
        cluster_id = np_to_tensor(np.array([0]), 'cpu')
